...
if __name__ == "__main__":
    ...
    train = pd.read_csv('../run_res/feat_train.csv')
    test = pd.read_csv('../run_res/feat_test.csv')

    y_oob = np.zeros(train.shape[0])
    ...
    for i, (train_index, test_index) in enumerate(kf):
        ...
        y_oob[test_index] = np.exp(scores_val) - shift
    ...
    df_oob = df_oob[['id']]
    df_oob['loss'] = y_oob
    df_oob.to_csv('../run_res/xgb_1106_as_is.csv', index=False)
